...
<?php 
  ...
  <main id="main" class="toggle-sidebar">
    ...
    <div class="pagetitle">
      <h1><span class="bi bi-eye-fill"></span> UNIT/s OUTAGE EVENT YESTERDAY</h1>
      <nav>
        <ol class="breadcrumb">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">OUTAGE EVENT OCCURRED YESTERDAY [<?=date('d-M-Y',strtotime("-1 days"));?>]</h5>
             ...
             <div class="table-responsive">
              ...
              $check_outage = mysqli_query($db,"select * from outage_event WHERE DATE(date_occ)=CURDATE()-1");
