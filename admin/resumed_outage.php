            ...
            <div class="card-body">
             ...
             <div class="table-responsive">
                <table class="table table-hover datatable">
                    ...
                    <tbody>
              <?php 
              $check_outage = mysqli_query($db,"select * from outage_event WHERE gf_id='$_SESSION[gf_id]' AND is_completed='Y'");
                ...
                while($rows = mysqli_fetch_assoc($check_outage)){ ?>
                  ...
                  <tr>
                    ...
                    <?php 
                      ...
                      $date2 = date("d-M-Y H:i", strtotime($rows['date_res']));
                    ...
                    ?>
                    <td><?=date("d-M-Y", strtotime($rows['date_res']))?></td>
